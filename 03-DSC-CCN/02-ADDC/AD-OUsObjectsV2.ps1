...
$FileServerName = "FS2"          # o el nombre real del fileserver en el dominio
$HomeShareName  = "TFGData"      # tu share
$HomeBase       = "\\$FileServerName\$HomeShareName\USUARIOS"
$HomeDrive      = "H:"


# Ya en dominio, usa credencial de dominio (recomendado)
